    ...
    public class StudentController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,LastName,FirstMidName,EnrollmentDate")] Student student)
        {
            ...
            catch (DataException dx)
            {
                ...
                ModelState.AddModelError("", "Unable to save changes;Try again/Contact System Administrator");
            }
...

        {
            ...
            {
                ViewBag.ErroMessage = "Delete failed. Try again, and if the problem persists see your system administrator.";
            }
            Student student = db.Students.Find(id);
            if (student == null)
            {
